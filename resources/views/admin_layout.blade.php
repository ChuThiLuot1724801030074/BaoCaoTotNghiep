	...
	<section style="color: #000;" id="container">
		...
		<aside>
			<div id="sidebar" class="nav-collapse">
				<!-- sidebar menu start-->
				<div style="overflow: hidden;outline: none;background: #81F7D8; class=" leftside-navigation">
			...
			<footer style="margin-top: 470px;margin-left: 20px;">
				<div id="text-2" class="large-6 columns widget left widget_text">
					...
					<div class="textwidget">
						<p>Shop Shoes - Giày thể thao</p>
						<p>Địa chỉ: 54/12 Bình Qưới B, Bình Chuẩn, Thuận An,Bình Dương</p>
						<p>Hotline : 0394796183</p>
					</div>
					<div class="wthree-copyright">
						<p>{{__('© 2020. Thiết kế bởi')}} <a href="https://www.facebook.com/Luot28122017/">Lượt Chu </a></p>
					</div>
				</div>
			</footer><!-- FOOTER 1 -->
